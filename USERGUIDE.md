...
> 2015년 10월 페블은 **페블 타임 라운드** 를 발표합니다. 화면의 형태와 해상도가 다르지만 페블 타임 기반 펌웨어를 사용하는 것으로 추측됩니다.

![페블 타임 라운드](https://www.filepicker.io/api/file/ZtBQwQZSP6gkG0uH96Rs/convert?h=450&w=450)
...
> 페블 타임 라운드는 15분 충전으로 1~2일의 배터리 시간을 가집니다.
...
| 구분        | 페블 클래식          | 페블 타임                | 페블 타임 라운드          |
|:------------|:---------------------|:-------------------------|---------------------------|
| 출시        | 2013년               | 2015년                   | 2015년                    |
| 무게        | 38g                  | 42.5g                    | 28g / 32g                 |
| (스틸)      | 56g                  | 62.3g / 116.3g           |                           |
| 밴드        | 22 mm                | (좌동)                   | 14mm / 20mm               |
| 크기        | 52mm x 36mm x 11.5mm | 40.5mm x 37.5mm x 9.5mm  | 38.5mm x 38.5mm x 7.5mm   |
| (스틸)      | 46mm x 34mm x 10.5mm | 40.5mm x 37.5mm x 10.5mm |                           |
| 디스플레이  | 1.26" 흑백+백라이트  | 1.25" 64 컬러+백라이트   | 원형 64 컬러+백라이트     |
| 해상도      | 144 x 168 (176 PPI)  | 144 x 168 (182 PPI)      | 188 x 188                 |
| 피드백      | 전동 모터            | (좌동)                   | (좌동)                    |
| 센서 1      | 지자계 센서(나침반)  | (좌동)                   | (좌동)                    |
| 센서 2      | 주변 광센서          | (좌동)                   | (좌동)                    |
| 센서 3      | 가속도(3축) 센서     | (좌동)                   | (좌동)                    |
| 블루투스    | 2.1 + 4.0(EDR, LE)   | (좌동)                   | (좌동)                    |
| 오디오 입력 | 없음                 | 방수 마이크              | (좌동)                    |
| 방수        | 5기압 / 40미터       | (좌동) (샤워/수영 가능)  | 생활방수 (샤워/수영 불가) |
...
커스텀 펌웨어나 언어팩은 안드로이드 기기와 아이폰에서 설치 가능합니다.

> 2015년 10월 아이폰용 페블 스톡 앱 3.3 업그레이드로 아이폰에서도 언어팩 설치 가능!
>
> 홈페이지에서 동영상을 참고해주세요.

개인적으로 A.J 님의 커스텀 펌웨어와 한글 언어팩을 사용하고 있습니다.
